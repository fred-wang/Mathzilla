...
// ready and will then perform some modifications to the MathJax code in order
// to improve performance and fix some rendering bugs.
// github.com/mathjax/MathJax/blob/master/unpacked/jax/output/NativeMML/jax.js

var _PreTranslate = function (state) {
...
xMathJaxConfig.textContent =
  "MathJax.Hub.Register.StartupHook(\"NativeMML Jax Ready\", function () {" +
    "MathJax.OutputJax.NativeMML.Augment({" +
      "preTranslate: " + _PreTranslate.toString() +
    "});" +
